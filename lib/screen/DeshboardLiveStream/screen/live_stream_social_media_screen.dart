...
class LiveStreamSocialMediaScreen extends StatefulWidget {
  const LiveStreamSocialMediaScreen({Key? key}) : super(key: key);

  @override
  State<LiveStreamSocialMediaScreen> createState() =>
      _LiveStreamSocialMediaScreenState();
}

class _LiveStreamSocialMediaScreenState
    extends State<LiveStreamSocialMediaScreen> {
