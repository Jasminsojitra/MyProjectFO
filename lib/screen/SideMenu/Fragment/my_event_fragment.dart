...
class MyEventFragment extends StatefulWidget {
  const MyEventFragment({Key? key}) : super(key: key);

  @override
  State<MyEventFragment> createState() => _MyEventFragmentState();
}

class _MyEventFragmentState extends State<MyEventFragment> {
  ...
  final List<MyEventModel> _listEvent = <MyEventModel>[
    MyEventModel(
                          ...
                          return Dialog(
                            ...
                            child: Container(
                              ...
                              child: SfDateRangePicker(
                                ...
                                rangeSelectionColor: AppColors.dateColor.withOpacity(0.2),
                                ...
                                onSelectionChanged: (args) {
                                  SchedulerBinding.instance.addPostFrameCallback((timeStamp) {
                                    ...
                                    if (startDate != null && enddate != null) {
                                      String starDate = DateFormat('dd MMM,yyyy').format(startDate!);
                                      String end_Date = DateFormat('dd MMM,yyyy').format(enddate!);
                                      selectDate = "$starDate - $end_Date";
                                      dateController.text = selectDate!;
                                    } else {
                                      ScaffoldMessenger.of(context)
                                          .showSnackBar(SnackbarWidget('select_start_date_end'.tr));
                                    }
                                  });
                                },
                              ),
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SmallText(
                                          text: _listEvent[index].mainText,
                                          size: 18,
                                          color: Colors.black),
                                      const SizedBox(height: 10),
                                      SmallText(
                                          text: _listEvent[index].dateText,
                                          size: 12,
                                          color: AppColors.txtgreyColor),
                                      const SizedBox(height: 15),
                                      SmallText(
                                          text: _listEvent[index].priceText,
                                          size: 16,
                                          color: Colors.black),
                                    ],
                                  ),
